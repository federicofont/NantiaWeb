...
import { Marcador } from '../clientes/marcador.model';
import { Documento } from '../clientes/documento.model';

import { EnvaseEnPrestamo } from '../clientes/envaseEnprestamo.model';
...
@Component ({
	selector: 'CuentasXCobrar_Detail',
	templateUrl: './rep_CuentasXCobrar_Detail.html',
    providers: [ClienteService,ListaPrecioService],
    styleUrls: ['./reportes.style.css']
})

export class RepCuentasXCobrarDetail{
